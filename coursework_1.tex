...
\href{https://github.com/jenjane118}{github.com/jenjane118}
...
\tightlist
\item
  View file and work out what is wrong with reads. Generate fastqc
  report.
\end{enumerate}
...
\tightlist
\item
  Use bowtie2 to align the reads to reference genome using two different
  options.
\end{enumerate}
...
\caption{multiq alignment scores}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{~/git/systems_bio/cw1_q1_multiqc.png}
\caption{multiqc sequence stats}
\end{figure}
...
\caption{fastqc sequence quality}
\end{figure}
...
better, I am not sure if an error rate above 4\% is acceptable for a
...
\emph{d) Use BLAST to identify origin of unmapped reads.}
